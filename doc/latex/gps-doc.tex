...
\huge Building a General Constraint-Based Puzzle Solver\\ % The assignment title
...
\input{third-puzzle.tex}
\input{kqueens-demo.tex}
\input{graph-coloring-demo.tex}
\input{third-puzzle-demo.tex}
\input{summary.tex}
%-----------------------------------------------
\begin{flushleft}
\bibliographystyle{acm}
\bibliography{literature} % viz. literatura.bib..
